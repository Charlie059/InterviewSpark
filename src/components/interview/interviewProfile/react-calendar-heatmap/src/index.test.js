...
describe('CalendarHeatmap', () => {
  ...
  it('shows values within its original date range', () => {
    const wrapper = shallow(
      <CalendarHeatmap endDate={new Date('2017-12-31')} startDate={new Date('2017-01-01')} values={values} />
    )
  ...
  it('should handle string formatted date range', () => {
    const wrapper = shallow(<CalendarHeatmap endDate='2017-12-31' startDate='2017-01-01' values={values} />)
...
describe('CalendarHeatmap props', () => {
  it('values', () => {
    ...
    const wrapper = shallow(
      <CalendarHeatmap endDate={new Date('2016-02-01')} startDate={new Date('2015-12-20')} values={values} />
    )
  ...
  it('showMonthLabels', () => {
    const visible = shallow(<CalendarHeatmap startDate={dateNDaysAgo(100)} values={[]} showMonthLabels />)
  ...
  it('showWeekdayLabels', () => {
    const visible = shallow(<CalendarHeatmap startDate={dateNDaysAgo(7)} values={[]} showWeekdayLabels />)

    expect(visible.find('text').length).toBeGreaterThan(2)

    const hidden = shallow(<CalendarHeatmap values={[]} showMonthLabels={false} showWeekdayLabels={false} />)
