...
// ** Hooks
  const { getRootProps, getInputProps } = useDropzone({
    ...
    multiple: false,
    maxSize: 5242880,
    accept: type === "image" ? {"image/*": [".jpg", ".jpeg", ".png"]} : {"application/*": [".pdf", ".doc", ".docx"]},
  ...
  const renderFilePreview = (file: File) => {
    if (file.type.startsWith("image")) {
      return <img style={{ width: "200", height: "120", objectFit: "cover" }} width={200} height={120} alt={file.name} src={URL.createObjectURL(file)} />;
    } else {
