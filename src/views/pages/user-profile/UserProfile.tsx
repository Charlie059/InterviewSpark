...
const UserProfile = ({ user, data }) => {
  ...
  const updateProfile = async(data) =>{
    ...
    // const profileStore = await DataStore.query(Profile, c => c.userID ('eq',userStore[0].id))
    // console.log(profileStore[0])
    // setData(data)
    // await DataStore.save(Profile.copyOf(profileStore[0], item => {
    //   item.profile_contact= data.contact
    //   item.profile_language= data.language
    //   item.profile_is_public= data.is_public
    //   item.profile_country= data.country
    // }))
  }
