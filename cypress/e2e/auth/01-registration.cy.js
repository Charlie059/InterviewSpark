import { serverId, testUsername, testEmail, invalidEmail, spaceEmail, testPassword, shortUsername, fName, lName, shortPassword, noUppercasePassword, noLowercasePassword } from '../../support/userUtils';
...
describe('User Registration', () => {
  ...
  it('should display the "Terms & Conditions" header and load pdf successfully', () => {
    ...
    cy.get('div.MuiDialogContent-root iframe')
      .should('have.attr', 'src', '/terms.pdf');
  })
});
